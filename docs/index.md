...
Ако го намирате полезен и желаете да подкрепите финасово работата по актуализирането, документирането и разработването на помощни скрипотове, може да дарите пет евро на този линк:
[Дарение](https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=JH75S5V3PNWFE&item_name=Fight+Fake+News+Sites&currency_code=EUR&amount=5&source=url)
